            ...
            <ul class="nav navbar-nav navbar-right">
                <li>
                    <a href="#">
                        ...
                        &nbsp;<img src="/static/img/4.gif" class="img-circle" alt="" width="24px" height="24px">
                    </a>
                </li>
                <li class="dropdown">
                    ...
                    <div class="panel-group" id="acc">
                        ...
                        <div class="panel panel-default">
                            ...
                            <div class="panel-collapse collapse" id="comment-panel-body">
                                <div class="panel-body">
                                    <ul class="list-group">
                                        <li class="list-group-item">
                                            <a href="javascript:void(0)" class="btn btn-default yx-nav-menu-btn">  &nbsp;查看评论 </a>
                                        </li>
                        ...
                        <div class="panel panel-default">
                            ...
                            <div class="panel-collapse collapse" id="feedback-panel-body">
                                <div class="panel-body">
                                    <ul class="list-group">
                                        <li class="list-group-item"><a href="">ss1</a></li>
                                        <li class="list-group-item"><a href="">ss2</a></li>
